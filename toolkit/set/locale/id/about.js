...
- .txt2img <checkpoint>[]|<prompt>
  Contoh: .txt2img 1234[]|sunset, beach, high resolution

▪︎ Dengan 1 Lora - jika ingin menambahkan satu efek/gaya Lora:
- .txt2img <checkpoint>[<lora>]|<prompt>
  Contoh: .txt2img 1234[5678]|cyberpunk, neon lights, cityscape
...
- Untuk mencari ID Lora: gunakan command .lorasearch <kata kunci>
  Contoh: .lorasearch cyberpunk untuk mencari gaya Lora bertema cyberpunk.
  
- Untuk mencari ID Checkpoint: gunakan command .checkpointsearch <kata kunci>
  Contoh: .checkpointsearch anime untuk mencari model checkpoint bertema anime.
