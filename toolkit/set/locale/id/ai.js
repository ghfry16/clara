...
Contoh: #lora 3|beautyfull cat with aesthetic jellyfish, sea god themes
 ...
 => ID adalah nomor dari model yang tersedia di list

silahkan lihat list model yang tersedia:
...
Gambar target akan diganti dengan wajah pafa gambar kedua
...
Sesi akan otomatis terhapus jika lebih dari 10 menit tidak ada interaksi swap
`
}
...
- *Untuk mengganti gambar target*
    - .faceswap-change
     ~ Gambar terakhir yang anda kirimkan 
       akan menjadi gambar target

Sesi akan otomatis terhapus setelah 10 menit
`
infos.bell = `
!-======[ Auto Ai Response ]======-!
