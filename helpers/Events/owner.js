...
`
    ...
    ev.on({ 
      ...
      await Exp.sendMessage(sender, { document: { url: b }, mimetype: "application/zip", fileName: `${path.basename(path.resolve("./"))} || ${Exp.func.dateFormatter(Date.now(), "Asia/Jakarta")}.zip`, ai: true }, { quoted: cht })
